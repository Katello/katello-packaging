...
%changelog
* Thu Feb 08 2018 Eric D. Helms <ericdhelms@gmail.com> 3.5.1.1-1
- Bump rubygem-katello to 3.5.1.1 (akofink@redhat.com)
...
- Update rubygem-katello spec to foreman 1.16 (akofink@redhat.com)

* Sat Sep 30 2017 Eric D. Helms <ericdhelms@gmail.com> 3.5.0-0.1.rc1
- Add katello-3.5.0.rc1 gem (akofink@redhat.com)
- Add relver, remove nightly (akofink@redhat.com)
- Refs #18874: jquery-ui-rails is no longer required (ericdhelms@gmail.com)
- Bump foreman-tasks and runcible requirement (jsherril@redhat.com)
